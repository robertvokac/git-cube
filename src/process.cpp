...
ProcessResult ProcessRunner::run(const std::vector<std::string>& args,
    ...
    try {
        check_spawn_action(
            posix_spawn_file_actions_adddup2(&actions, standard_output.write.get(), STDOUT_FILENO),
        ...
        check_spawn_action(posix_spawn_file_actions_addclose(&actions, standard_output.read.get()),
        ...
        check_spawn_action(posix_spawn_file_actions_addclose(&actions, standard_output.write.get()),
        ...
        while (true) {
            ...
            pollfd descriptors[2]{
                {standard_output.read.get(), POLLIN, 0},
